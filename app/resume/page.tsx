...
export default function ResumePage() {
  return (
    <div className="shell py-32" style={{ ['--max' as string]: '52rem' }}>
      ...
      <div className="mt-8 flex flex-wrap gap-3"><a href={profile.resume} className="btn btn-primary" download>Download PDF</a><a href="/" className="btn">Back to the control plane</a></div>
